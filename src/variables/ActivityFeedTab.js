                        ...
                        <Card className="">
                            ...
                            <CardBody>
                                ...
                                <div className="d-flex align-items-center">
                                    <a href="#pablo">
                                        <img alt="..." className="img-fluid rounded" src={playlist.deployment.thumbnail} style={{ width: '40px',height: '40px'}}/>
                                    </a>
                                    <div className="mx-3">
                                ...
                                <p>Personal profiles are the perfect way for you to grab their attention and persuade recruiters to continue reading your CV because you’re telling them from the off exactly why they should hire you.</p>
                                <img alt="..." class="img-fluid rounded" src="/argon-dashboard-pro-react/static/media/img-1-1000x600.3869811c.jpg"/>
                                {messages.map((message, index) => {
                                    if (message.playlist.id === playlist.id) {
                                        return (
                                            <React.Fragment key={index}>
                                                <div className="allign-items-center row" >
                                                ...
                                                <a className="avatar rounded-circle" href="#pablo" >
                                                    <img alt="..." className="img-fluid rounded-circle" src={message.messagefile} style={{ width: '40px',height: '40px'}}/>
                                                </a>
                                                </div>
