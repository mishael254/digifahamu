...
const Header = () => {
  ...
  useEffect(() => {
    ...
    //set the count for members registered
    setMembersCount(members.length);

  }, [deployments,projects,feedbacks,playlists,members]); // Trigger effect when deployments data changes
